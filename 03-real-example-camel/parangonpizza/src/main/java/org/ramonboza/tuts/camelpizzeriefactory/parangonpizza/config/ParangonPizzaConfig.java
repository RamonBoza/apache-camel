package org.ramonboza.tuts.camelpizzeriefactory.parangonpizza.config;
...
@Configuration
public class ParangonPizzaConfig {
    ...
    public Destination getDefaultDestination() {
        Destination defaultDestination = new ActiveMQQueue("ParangonPizza");
